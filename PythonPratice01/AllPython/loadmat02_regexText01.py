...
dataFile=r'D:/PyAI2/MSO/'+MatName
...
#mak=mat['imgIdx']['anno']
#print(mat['imgIdx']['anno'])
#print(mak[(0,0)])
#print(dir(mak[(0,0)]))
#print(mat[mak[(0,0)]].value)
#for i in mak[(0,0)]:
#    print(i)

#print(mak)
#print(mat['imgIdx']['name'])

#--------------------------------------------------------------------------
start=time.time()
matcontent = hdf5storage.loadmat(dataFile)
print(matcontent.keys())
print("-"*50)
#print(matcontent['imgIdx'])
print("-"*50)
print(matcontent['imgIdx'][0][0])
print("="*50)
