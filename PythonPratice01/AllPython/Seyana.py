...
if __name__=="__main__":
    try:
        ...
        #imgurl=win32clipboard.GetClipboardData(win32con.CF_TEXT).decode()
        #win32clipboard.CloseClipboard()
        imgurl="http://p1.music.126.net/Kr5HAy_BD5R0jxA9Xt9UZA==/109951163549389045.jpg"
        GetandSetWallpaper(imgurl)
    except:
        win32api.MessageBox(0, "複製內容錯誤!!", "錯誤",win32con.MB_ICONWARNING)
        print("copy error!!")
    #print("請輸入要設定的圖片網址~\n圖片網址取得方式: 網路上找到的圖片，對其點擊右鍵按下複製圖片網址，即可取得")
    #imgurl=input("圖片網址: ")
