...
pgmdir="D:\\PyAI2\\UcoHead\\train\\"

def PgmToPng(pgm):
    image=Image.open("D:\\PyAI2\\UcoHead\\train\\"+pgm)
    pattern_imgName=re.compile("""([A-Za-z0-9]*)\.pgm""")
    imgName=re.findall(pattern_imgName,pgm)[0]
    print(imgName)
    image.save("D:\\PyAI2\\UcoHead\\trainPNG\\"+imgName+".png")
