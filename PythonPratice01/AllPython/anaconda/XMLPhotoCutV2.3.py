    ...
    try:
        ...
        for xml_object in xml_objects:
            ...
            if xml_class in classes or classes==['']:
                ...
                img_num+=1
                xmin=int(xml_object_bndbox.find("xmin").text)
                ymin=int(xml_object_bndbox.find("ymin").text)
                xmax=int(xml_object_bndbox.find("xmax").text)
                ymax=int(xml_object_bndbox.find("ymax").text)
