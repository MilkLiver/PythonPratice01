...
xmldir_path=r"D:\PyAI\del"
#圖片來源資料夾路徑
#imagedir_path=r"D:\PyAI\NewOffsetCarXml"
imagedir_path=r"D:\PyAI\cars_train\00001.jpg"
#裁切後的圖片資料夾路徑
...
def readXML(xml_name):
    ...
    try:
        ...
        for xml_object in xml_objects:
            ...
            CreateCutImage(xmin,ymin,xmax,ymax,os.path.splitext(xml_name)[0]+imageformat,os.path.join(imagedir_path,xml_filename),xml_object.find("name").text)
