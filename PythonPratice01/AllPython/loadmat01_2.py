...
def CreateXml(jpgName,xmin,ymin,xmax,ymax,jpgtype):
    ...
    filename_name=doc.createTextNode(str(jpgtype)+"_"+jpgName)
    filename.appendChild(filename_name)
    root.appendChild(filename)

    filepath=doc.createElement('path')
    filepath_path=doc.createTextNode(NewCarPhotos+str(jpgtype)+"_"+jpgName)
    ...
    im.save(NewCarPhotos+str(jpgtype)+"_"+xmlname+'.jpg')
    with open (SaveDirPath+str(jpgtype)+"_"+xmlname+".xml","w") as wf:
