...
def getWallpaper():
    ...
    jayofolder = os.path.exists(JayoPhotos)
    if not jayofolder:
        os.makedirs(JayoPhotos)
    ...
    for i in range(len(imgurl)):
        ...
        JayoWallpaper=JayoPhotos+"Jayopicture"+str(i)+".png"
